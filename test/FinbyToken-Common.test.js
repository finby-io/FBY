...
const finbyToken = artifacts.require('finbyToken');
...
/**
 * finbyToken Principal EC20 Functionalities.
 *
 ...
 */
contract('FinbyToken: Common ERC20 Functionalities', ([owner, recipient, anotherAccount, taxRecipientAddr, boardAccount, burner]) =>
{
    let tokenInstance;

    beforeEach(async () =>
    {
        tokenInstance = await finbyToken.new(taxRecipientAddr);
    });
