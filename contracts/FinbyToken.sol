...
/**
 * @title finby Utility Token
 *
 * @dev Implementation of the main finby token smart contract.
 */
contract FinbyToken is ERC20Pausable, ERC20Burnable, ERC20Detailed, Ownable
{
    ...
    constructor(address taxRecipientAddr) public ERC20Detailed("Finby - Juice Coin", "JUICE", 18)
    {
    ...
    /**
     * @dev Special finby transfer token for a specified address.
     *
